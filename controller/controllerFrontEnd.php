...
function post()
{
    ...
    require('../view/redactor_lecture.php');
}
...
function mPost()
{
    ...
    require('../view/redactor_modification.php');
}
...

{
    ...
    if ($affectedLines === false) {
        ...
        ?>
    <script language="javascript">document.location="indexFrontEnd.php"</script>;<?php
    }
}
...
function avComment()
{
    ...
    require('../view/redactor_AVComments.php');
}
...
function dBufferComment()
{
   ...
   //header('Location: indexFrontEnd.php?action=avComment' );
    ?>
    <script language="javascript">document.location="indexFrontEnd.php?action=avComment"</script>;<?php
}
...
function DisplaySComment()
{
   ...
   require('../view/redactor_signalComments.php');
...
function dSignalComment()
{
   ...
   //header('Location: indexFrontEnd.php?action=DisplaySComment' );
    ?>
    <script language="javascript">document.location="indexFrontEnd.php?action=DisplaySComment"</script>;<?php
}
